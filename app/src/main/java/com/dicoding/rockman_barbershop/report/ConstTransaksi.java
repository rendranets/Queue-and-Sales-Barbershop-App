...
public class ConstTransaksi {
    ...
    static CollectionReference userReference = mDatabase.collection("Transaksi");
    static FirebaseAuth fAuth = FirebaseAuth.getInstance();
    CollectionAdapter collectionAdapter;
    static String userIds;

//    public static String data = "";
    public static ArrayList<RiwayatTransaksi> transaksiList(Context context) {
...
//        String userId;
        ...
        userReference.orderBy("kode_transaksi", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
